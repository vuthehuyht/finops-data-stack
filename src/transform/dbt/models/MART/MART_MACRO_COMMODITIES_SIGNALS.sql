...
SELECT
  ...
  -- Interest rates
  IR.FED_RATE::NUMERIC(38, 4) AS FED_RATE,
  IR.TREASURY_10Y::NUMERIC(38, 4) AS TREASURY_10Y,
  IR.TREASURY_5Y::NUMERIC(38, 4) AS TREASURY_5Y,
  ...
  END::NUMERIC(38, 4) AS REAL_INTEREST_RATE,
  -- Exchange rate signals
  ER.USD_VND_RATE::NUMERIC(38, 4) AS USD_VND_RATE,
  ER.EXCHANGE_RATE_VOLATILITY_30D::NUMERIC(18, 6) AS EXCHANGE_RATE_VOLATILITY_30D,
  -- Macro indicators
  M.CPI_VALUE::NUMERIC(38, 4) AS CPI_VALUE,
  M.POLICY_RATE::NUMERIC(38, 4) AS POLICY_RATE,
  -- Commodity prices
  CP.BRENT_CRUDE_PRICE::NUMERIC(38, 4) AS BRENT_CRUDE_PRICE,
  CP.WTI_PRICE::NUMERIC(38, 4) AS WTI_PRICE,
  CP.GOLD_PRICE::NUMERIC(38, 4) AS GOLD_PRICE,
  CP.STEEL_HRC_PRICE::NUMERIC(38, 4) AS STEEL_HRC_PRICE,
  CP.GASOLINE_SINGAPORE_PRICE::NUMERIC(38, 4) AS GASOLINE_SINGAPORE_PRICE,
  CP.BALTIC_DIRTY_TANKER_INDEX::NUMERIC(38, 4) AS BALTIC_DIRTY_TANKER_INDEX,
  ...
  END::NUMERIC(38, 4) AS CRACK_SPREAD_PROXY,
